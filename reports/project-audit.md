...
审查时间：2026-08-16
审计范围：仓库源码、可安装 Skill 包边界和公开发布材料；公开版本以远程 Git Tag 和 GitHub Release 为准。
...
- 测试、审计和打包结果会随工作树变化；没有对应命令输出时，不应写成“已通过”。
...
上面的命令是下一次发布前的复核入口；本报告不把未在当前工作树中重跑的结果标记为通过。
