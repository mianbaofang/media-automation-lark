...
PY_PKGS = ["requests", "feedparser", "beautifulsoup4", "pandas", "openpyxl", "python-docx", "pypdf", "markitdown"]
# 导入名与包名可能不同
IMPORT_MAP = {
    "requests": "requests",
...
PIP_EXTRAS = {
    "markitdown": "markitdown[all]",  # Microsoft 文件转 Markdown 工具，供场景 C 处理本地文件
}
